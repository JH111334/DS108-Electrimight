...
Toàn bộ pipeline được bao phủ bởi 49 unit tests sử dụng pytest.
Các module được kiểm thử bao gồm \texttt{data\_loader}, \texttt{data\_assertions}, và \texttt{anomaly\_labels}.
