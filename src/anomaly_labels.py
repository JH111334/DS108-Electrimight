...
def label_leakage(
    ...
    Nguyen ly: So sanh trung binh truot dai han voi trung binh tong the.
    Khi duong trung binh truot vuot qua nguong % so voi muc co so ban dau
    (tuan dau tien), do la dau hieu suy thoai hieu suat tiem tien.
    ...
    # Baseline = trung binh tuan dau tien
...
def score_leakage(
    ...
    Score phan cap theo muc do tang:
      > 20% -> 1.0 (nguy hiem)
      > 10% -> 0.7 (canh bao)
      >  5% -> 0.4 (nhe)
      <= 5% -> 0.0
