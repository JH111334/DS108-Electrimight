...
> Methodology là phần "trái tim" của báo cáo kỹ thuật. IEEE yêu cầu mô tả đủ chi tiết để ngườii đọc có thể **tái lập (replicate)** công việc của bạn.
...
2. **Data Cleaning**:
   - Loại bỏ duplicates
   - Nội suy tuyến tính (linear interpolation) cho missing values — phù hợp chuỗi thờii gian
   - Sắp xếp theo thờii gian
